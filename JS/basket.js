...
for (let itemBasket of addBasket) {
    itemBasket.onclick = function (e) {
        ...
        let productPrice = Number(this.parentElement.nextElementSibling.querySelector(".totalPrice").innerText);
        ...
        let price = this.parentElement.nextElementSibling.querySelector(".totalPrice").innerText;
